...
const live2d_path = "https://live.050002.xyz/";
const model_path="https://api.050002.xyz/";
...
async function loadScriptsInOrder(){
	...
	await Promise.all([
		...
		loadExternalResource("https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0/css/all.min.css", "css")
	])
